...
<body class="bg-dark d-flex justify-content-center align-items-center" style="min-height: 100vh;">
	...
	<div class="card border-0 w-25 text-center">
		<div class="card-body">
			<h1 class="font-weight-bold text-secondary my-4">CTC <span class="text-warning">NETWORK</span></h1>
				<div class="nav nav-tabs nav-justified mx-4 font-weight-bold">
				...
				<div class="tab-content mx-4">
					<div class="tab-pane fade show active" id="login">
						<form method="post">
							<input type="text" name="l_username" placeholder="Username" class="form-control rounded-0 my-3" required>
							<input type="password" name="l_pass" placeholder="Password" class="form-control rounded-0 my-3" required>
							<hr>
							<button class="btn btn-block btn-warning font-weight-bold mb-4" type="submit" name="log_in">Log In</button>
						</form>
						<?php
							if (isset($_POST['log_in'])) {
								...
								if ($data) {
									if ($data['attribute'] === 'Cleartext-Password') {
										...
										echo "<script>alert('This username has be suspend!')</script>";
					...
					<div class="tab-pane fade" id="signup">
						<form method="post">
							<div class="form-row my-3">
								<div class="col">
									<input type="text" name="s_name" placeholder="Name" class="form-control rounded-0" required>
								</div>
								<div class="col">
									<input type="text" name="s_lastname" placeholder="Lastname" class="form-control rounded-0" required>
								</div>
							</div>
							<input type="text" name="s_username" placeholder="Username" class="form-control rounded-0 my-3" required>
							<input type="password" name="s_pass" placeholder="Password" class="form-control rounded-0 my-3" required>
							<hr>
